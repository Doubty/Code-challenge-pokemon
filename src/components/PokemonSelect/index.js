   ...
   setId(pokemonRes.data.id)
    ...
    return (
      <div className="col-md-2 " ref={dragRef}>
        <div className="card" style={{ border: isDragging ? "5px solid #68BB2B" : "0px", backgroundColor: '#E9EAEC'}}>
             ...
             style={{ borderRadius: '100%', color: 'white',position: 'relative', right: '0.5rem', top: '-30rem', backgroundColor: '#90ADC6', width: '2.5rem', height: '2.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center'}}
             >#{id}</span>
