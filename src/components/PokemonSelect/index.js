    ...
    <div className="col-md-2 " ref={dragRef}>
      <div className="card" style={{ border: isDragging ? "5px solid #68BB2B" : "0px", backgroundColor: '#E9EAEC' }}>
        ...
        <span
          ...
          style={{ borderRadius: '100%', color: 'white', position: 'relative', left: '0.5rem', top: '5rem', backgroundColor: '#90ADC6', width: '2.5rem', height: '2.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
        >#{id}</span>
